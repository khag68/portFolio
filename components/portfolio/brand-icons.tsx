 ...
 * lucide-react no longer ships brand icons (GitHub, LinkedIn, …),
 * so we provide them here. They inherit `currentColor` and accept
 * the same className/size props as a lucide icon.
 */
